...
Copyright 2026 The Paraflate Authors
...
Individual crates in this workspace may state **SPDX** identifiers such as `MIT OR Apache-2.0`; you may comply with either license where that dual licensing applies.
